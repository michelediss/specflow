...
function enforceArchitect(files) {
  const forbidden = files.filter(
    (file) => file.startsWith("app/src/") || file.startsWith("app/tests/")
  );
...
/**
 * Developer mode forbids editing the single source of truth (specflow/input + specflow/architect + DB schema).
 */
